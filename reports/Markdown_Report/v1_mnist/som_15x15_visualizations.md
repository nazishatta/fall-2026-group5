...
*The structure and explanatory style of this report follow the example presented at* **[SOM Iris Training](https://amir-jafari.github.io/SOM/iris_training.html)** *with adaptations for the MNIST digit dataset. For further details on each visualisation type, consult the NNSOM API reference and the tutorial pages linked throughout the document.*
